...
// ✅ Customer Database Schema - for Retailers, Electricians, Architects, etc.
...
customerDBSchema.index({ companyName: "text", name: "text", city: "text" });

// ✅ Auto-generate Customer UID before save if not provided
customerDBSchema.pre("save", async function (next) {
  if (!this.customerUID) {
...
const CustomerDB = mongoose.model("CustomerDB", customerDBSchema);
